...
benchOptsParser :: Parser BenchmarkOptsMonoid
benchOptsParser = BenchmarkOptsMonoid
...
buildOptsMonoidParser hide0 =
  ...
  where
    ...
    options =
        ...
        tests <*> testOptsParser <*> benches <*> benchOptsParser <*> reconfigure <*>
        cabalVerbose
    libProfiling =
        maybeBoolFlags
            "library-profiling"
...
-- FIXME hide args
testOptsParser :: Parser TestOptsMonoid
testOptsParser = TestOptsMonoid
       <$> maybeBoolFlags
                          "rerun-tests"
